...
<textarea name="message" wrap="physical" placeholder="Please enter your message here" cols="50" rows="4" onKeyDown='textCounter(this.form.message,this.form.remLen,160);' onKeyUp='textCounter(this.form.message,this.form.remLen,160);' onfocus='if(this.value==this.defaultValue){this.value='';}' onblur='if(this.value==''){this.value=this.defaultValue;}'>Please enter your message here</textarea>
<br>
