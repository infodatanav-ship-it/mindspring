...
//       $link = mysqli_connect("geode.mindspring.local", "pramod", "6cDa*2zmZ7HypnMV");
//         or die("Could not connect : " . mysqli_error("Dunno"));
    
//        $link = mysqli_connect("geode.mindspring.local", "pramod", "banana");
    
//         mysqli_select_db("msi") or die("Could not select database");
...
//Below the dates are hardcoded for test purposes (to ensure there is data available on dev)
        ...
        // $today = date("2018-11-25");
        // $lastday = date("2018-11-31", strtotime($firstday));
...
//	and msi_clients.email='jacquesd@cjpchemcpt.co.za'
        ...
        and msi_billing.date between '$firstday' and '$today'
        ...
        date('d F Y', strtotime($firstday))." until ".date('d F Y', strtotime($today)). ". <br /><br />
